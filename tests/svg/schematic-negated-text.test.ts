...
test("renders Altium whole-name and per-character negation forms", () => {
  const source = [
...
test("renders negated connectivity names", () => {
  const source = [
    "|HEADER=Protel for Windows - Schematic Capture Ascii File Version 5.0",
    "|RECORD=31|CUSTOMX=200|CUSTOMY=140",
    "|RECORD=15|LOCATION.X=20|LOCATION.Y=120|XSIZE=100|YSIZE=80",
    String.raw`|RECORD=16|OWNERINDEX=1|DISTANCEFROMTOP=2|NAME=\ENTRY|TEXTFONTID=1`,
